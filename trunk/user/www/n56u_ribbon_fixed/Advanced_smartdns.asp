						...
						<div>
                            <ul class="nav nav-tabs" style="margin-bottom: 10px;">
                                ...
                                <div class="row-fluid">
									...
									<div class="alert alert-info" style="margin: 10px;">🚀 <b>网页秒开的秘密武器 - SmartDNS！</b><br>
									它能有效防止网页被乱七八糟的域名污染，还能帮你自动挑选最快的访问节点，让家里上网像飞一样快！甚至还能顺手过滤一点小广告哦~ ✨<br>
									🌐 官方网站: <a href="https://pymumu.github.io/smartdns/" target="_blank">https://pymumu.github.io/smartdns/</a>
									</div>
</div>
<div id="wnd_sm_cfg">
