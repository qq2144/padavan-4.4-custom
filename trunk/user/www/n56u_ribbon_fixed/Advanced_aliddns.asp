						...
						<div class="box well grad_colour_dark_blue">
                            ...
                            <ul class="nav nav-tabs" style="margin-bottom: 10px;">
								...
								<div class="row-fluid">
									...
									☁️ <b>让你的域名永远认得家 - 阿里云 DDNS！</b><br>
									如果你有动态公网 IP 和自己的域名，开启它就能自动将域名和家里最新的 IP 绑定，再也不怕 IP 变了失联啦！<br>
												<ul style="padding-top:5px;margin-top:10px;float: left;">
												<li>💡 <b>小提示：</b>使用前需要在阿里云添加一条 A 记录。它会自动帮你更新 IP 哦。</li>
												<li>🔑 点 <a href="https://help.aliyun.com/knowledge_detail/38738.html" target="blank"><i><u>这里</u></i></a> 查看如何获取 Access Key ID 和 Secret (就像你域名的专属钥匙)。</li>
												<li>🌐 点 <a href="https://help.aliyun.com/knowledge_detail/39844.html" target="blank"><i><u>这里</u></i></a> 查看不同域名注册商修改 DNS 的方法。</li>
												<li>📦 开源项目: <a href="https://github.com/kyriosli/koolshare-aliddns" target="blank"><i>koolshare-aliddns</i></a></li>
												</ul>
									</div>
