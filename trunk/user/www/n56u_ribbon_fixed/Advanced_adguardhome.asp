						...
						<div class="box well grad_colour_dark_blue">
                            ...
                            <ul class="nav nav-tabs" style="margin-bottom: 10px;">
								...
								<div class="row-fluid">
									...
									<p>🎉 <b>全屋广告拦截神器！</b>只需在路由器上开启，家里的手机、电脑、智能电视等<b>所有设备</b>都能享受无广告清爽体验，再也不用挨个设备装去广告插件啦！✨<br>
									<small>* 默认账号密码都是 <code>adguardhome</code>，如果想改的话可以去 <code>/etc/storage/adg.sh</code> 里面修改哦~</small>
									</p>
									🌍 官方主页: <a href="https://adguard.com/" target="blank">https://adguard.com/</a>
									</div>
